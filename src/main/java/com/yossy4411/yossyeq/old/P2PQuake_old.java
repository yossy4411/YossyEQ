package com.yossy4411.yossyeq.old;
...
public class P2PQuake_old {
    private static int peerId = -1;
    private static final Logger LOGGER = Logger.getLogger(P2PQuake_old.class.getName());
    ...
    public static void main(String[] args) throws IOException {
        ...
        connectToServer();
        scheduler.scheduleAtFixedRate(P2PQuake_old::serverEcho, 10, 10, TimeUnit.MINUTES);
    }
